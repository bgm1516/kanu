            ...
            <div class="carousel-inner">
              ...
              <div class="item">
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-5">
                    <div class="screenshot wow bounceInRight">
                      <img src="./resources/img/screenshots/2.png" class="img-responsive" alt="" />
                    </div>
                  </div>
                </div>
              </div>
...
<footer>
  ...
  <script src="./resources/js/mb.bgndGallery.js"></script>
  <script src="./resources/js/mb.bgndGallery.effects.js"></script>
  <script src="./resources/js/jquery.simple-text-rotator.min.js"></script>
